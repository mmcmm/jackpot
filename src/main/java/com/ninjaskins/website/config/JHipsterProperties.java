...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "ninjaskins@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "ninjaskins API";

        private String description = "ninjaskins API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "ninjaskins";
